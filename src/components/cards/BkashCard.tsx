  ...
  return (
    <section className="p-5 max-sm:p-2.5">
      ...
      >
        ...
        <CardBack bkashNumber={bkashNumber} />
      </article>
    </section>
  );
};
...
const CardFront = ({
  ...
  return (
    <section
      className="absolute p-6 rounded-2xl  size-full text-white max-sm:p-4 bg-gradient-to-r from-[#E2136E] to-[#FD363D] backface-hidden"
    ...
    >
      <header className="flex justify-between items-start mb-10">
        ...
        />
        <p className="text-sm text-right">bKash</p>
      </header>
...
const CardBack = ({ bkashNumber }: { bkashNumber: string }) => {
  return (
    <section
      className="absolute rounded-2xl  size-full bg-gradient-to-r from-[#E2136E] to-[#FD363D]"
      style={{
